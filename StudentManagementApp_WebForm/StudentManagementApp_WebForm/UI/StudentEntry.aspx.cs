    ...
    public partial class StudentEntry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                txtdropdown.DataValueField = "DepartmentId";
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            try
            {
                Student student = new Student(txtName.Text, txtEmail.Text, txtRegNo.Text,Convert.ToInt32(txtdropdown.SelectedValue));
                bool isSaved= studentManager.Insert(student);               
                msgLabel.Text = isSaved ? "Saved Successfully!" : "RegNo is Exist!";
            }
